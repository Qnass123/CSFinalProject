    ...
    , ui(new Ui::MainWindow)
{
   ...
   ui->graphicsView->setFocusPolicy(Qt::NoFocus);
    ...
    int x = 60, y = 60;                             // x y in mainwindow
...
void MainWindow::initLabels()
{
    ...
    score_title->setGeometry(660, 12, 60, 26);

    score = new QLabel(this);
    score->setIndent(-80);
    score->setText("0");
    score->setStyleSheet("QLabel {font-family: Fixedsys;color: white;font-size: 16px;}");
    score->setGeometry(720, 12, 150, 26);

    win_label = new QLabel(this);
    win_label->hide();
    win_label->setText("You win!");
    win_label->setStyleSheet("QLabel {font-family: Fixedsys;color: white;font-size: 16px;}");
    win_label->setGeometry(310, 300, 150, 26);

    lose_label = new QLabel(this);
    lose_label->hide();
    lose_label->setText("You lose!");
    lose_label->setStyleSheet("QLabel {font-family: Fixedsys;color: white;font-size: 16px;}");
    lose_label->setGeometry(310, 300, 150, 26);
